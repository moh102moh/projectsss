...
import ProMasterPricing from '../components/ProMasterPricing.jsx';
...
function Navbar() {
  ...
  const t = {
    ...
    ar: { main: 'الرئيسية', gallery: 'المعرض', store: 'المتجر', cert: 'الشهادات', pricing: 'الباقات', contact: 'تواصل' }
  };
        ...
        <ul className={servicesStyles.navLinks}>
          ...
          <li>
            <Link href="/pricing" legacyBehavior>
              <a className={`${servicesStyles.navLink} ${servicesStyles.active}`}>{t[lang].pricing}</a>
            </Link>
          </li>
        </ul>
        ...
        <div className={servicesStyles.sideMenuOverlay} onClick={() => setMobileMenuOpen(false)}>
          <div className={servicesStyles.sideMenu} onClick={(e) => e.stopPropagation()}>
            ...
            <ul>
              ...
              <li><Link href="/pricing" legacyBehavior><a className={servicesStyles.active} onClick={() => setMobileMenuOpen(false)}>{t[lang].pricing}</a></Link></li>
              <li>
...
function PricingPage() {
  ...
  return (
    <>
      <Head>
        <title>{lang === 'ar' ? 'PROMASTER | باقاتنا' : 'PROMASTER | Pricing'}</title>
      </Head>

      <div className={servicesStyles.wrapper} dir={lang === 'ar' ? 'rtl' : 'ltr'}>
        <Navbar />
        <ProMasterPricing lang={lang} />
